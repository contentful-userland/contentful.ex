defmodule Contentful.Delivery.Assets do
  ...
  ## Examples
      space = "my_space_id"
      {:ok, %Asset{ sys: %{ id: "<asset_id>"}} = asset}
  ...
  def fetch_one(asset_id, %Space{sys: %{id: space_id}}, env, api_key) do
    space_id
  ...
  def fetch_one(asset_id, space_id, env, api_key) do
    fetch_one(asset_id, %Space{sys: %{id: space_id}}, env, api_key)
  end
  ...
  ## Examples
      ...
      {:ok, [
        %Asset{ sys: %{ id: "foobar_0"}},
        %Asset{ sys: %{ id: "foobar_1"}},
  ...
  @spec build_single_request(String.t(), Asset.t(), String.t() | nil, String.t() | nil) ::
          tuple()
